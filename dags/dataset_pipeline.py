...
from pipeline.load_dataset import export_review_queue as load_ds
...
telegram_dag = DAG(
    dag_id="telegram_bot_service4ds",
...
load_dataset = PythonOperator(
    ...
    python_callable = load_ds,
    dag = pipeline_dag,

)

check_request >> stop_pipeline
check_request >> fetch_comments >> load_dataset
